  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {tab !== "trash" && (
          <Button asChild>
            <Link href="/admin/items/category/add">
      ...
      <Tabs defaultValue={tab} className="w-full">
        <TabsList>
          <TabsTrigger value="all" asChild>
            <Link href="/admin/items/category?tab=all&page=1">All Categories</Link>
          </TabsTrigger>
          <TabsTrigger value="trash" asChild>
            <Link href="/admin/items/category?tab=trash&page=1">Trash</Link>
          </TabsTrigger>
        </TabsList>
