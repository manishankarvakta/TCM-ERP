      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button asChild variant="outline">
            <Link href="/admin/settings?section=organization">Back to List</Link>
          </Button>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {tab !== "trash" && (
          <Button asChild>
            <Link href="/admin/settings?section=organization&add=true">
      ...
      <Tabs defaultValue={tab} className="w-full">
        <TabsList>
          <TabsTrigger value="all" asChild>
            <Link href="/admin/settings?section=organization&tab=all&page=1">All Organizations</Link>
          </TabsTrigger>
          <TabsTrigger value="trash" asChild>
            <Link href="/admin/settings?section=organization&tab=trash&page=1">Trash</Link>
          </TabsTrigger>
        </TabsList>
