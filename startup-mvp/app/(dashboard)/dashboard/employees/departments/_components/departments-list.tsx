...
import { trashDepartment, bulkUpdateDepartmentStatus, deleteDepartmentPermanently } from "../_actions/department.action";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function DepartmentsList({
  ...
  const handleDeletePermanently = async () => {
    ...
    startTransition(async () => {
      const result = await deleteDepartmentPermanently(permanentDeleteId);
      if (result.success) {
        setPermanentDeleteId(null);
        toast({ title: "Success", description: "Department deleted permanently" });
        router.refresh();
      } else {
