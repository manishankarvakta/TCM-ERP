...
import { trashEmployeeType, bulkUpdateEmployeeTypeStatus, deleteEmployeeTypePermanently } from "../_actions/employee-type.action";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function EmployeeTypesList({
  ...
  const handleDeletePermanently = async () => {
    ...
    startTransition(async () => {
      const result = await deleteEmployeeTypePermanently(permanentDeleteId);
      if (result.success) {
        setPermanentDeleteId(null);
        toast({ title: "Success", description: "Employee type deleted permanently" });
        router.refresh();
      } else {
  ...
  return (
    <div className="space-y-4">
      ...
      <AlertDialog open={!!permanentDeleteId} onOpenChange={() => setPermanentDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete Employee Type Permanently</AlertDialogTitle>
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete the employee type from the database.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel disabled={isPending}>Cancel</AlertDialogCancel>
