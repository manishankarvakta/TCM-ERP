  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Billing Milestones</h1>
      ...
      <Card className="border-dashed">
        <CardHeader>
          <CardTitle className="text-xl">Billing Milestones</CardTitle>
          <CardDescription>
        ...
        <CardContent className="h-64 flex flex-col items-center justify-center text-center text-muted-foreground space-y-3">
          ...
          <div className="max-w-md">
            <h3 className="font-semibold text-foreground text-lg mb-1">Billing Milestones</h3>
