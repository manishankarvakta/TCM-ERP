...
export async function createClient(input: {
  ...
  try {
    ...
    await notifyUserAction({
      ...
      message: `Client "${client.name || client.email}" has been created successfully.`,
...
export async function updateClient(input: {
  ...
  try {
    ...
    await notifyUserAction({
      ...
      message: `Client "${client.name || client.email}" has been updated. Changes: ${changes.join(", ")}.`,
...
export async function deleteClient(clientId: string) {
  try {
    ...
    await notifyUserAction({
      ...
      message: `Client "${clientToDelete.name || clientToDelete.email}" has been moved to trash.`,
...
export async function bulkUpdateClientStatus(
  ...
  try {
    ...
    await notifyUserAction({
      userId: session.user.id,
      action: "client_bulk_updated",
      title: "Clients Updated",
      message: `${clients.length} client(s) have been ${actionText}.`,
...
export async function deleteClientsPermanently(clientIds: string[]) {
  try {
    ...
    await notifyUserAction({
      ...
      title: "Clients Permanently Deleted",
      message: `${clients.length} client(s) have been permanently deleted.`,
