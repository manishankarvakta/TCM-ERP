...
export const posSettingsSchema = z.object({
  ...
  headerText: z.string().min(1, "Header text is required").default("TCM"),
  ...
  showCustomerPoints: z.boolean().default(false),
  ...
  allowTax: z.boolean().default(false),
