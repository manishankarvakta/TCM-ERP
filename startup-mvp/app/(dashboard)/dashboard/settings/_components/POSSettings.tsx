                ...
                <CardContent className="space-y-4">
                  ...
                  {posForm.watch("securePos") && (
                    <div className="pl-6 pt-3 border-t border-border grid grid-cols-2 gap-4 animate-in fade-in duration-200">
                      ...
                      <Controller
                        name="securePosDiscount"
                        control={posForm.control}
                        render={({ field }) => (
                          <div className="flex items-center space-x-2.5">
                            <Checkbox
                              id="securePosDiscount"
                              checked={field.value}
                              onCheckedChange={field.onChange}
                            />
                            <Label htmlFor="securePosDiscount" className="font-semibold text-sm cursor-pointer select-none">
                              Discount
                            </Label>
                          </div>
                        )}
                      ...
                      {/* Customer Points Permission Toggle */}
                      <Controller
                        name="securePosPoints"
                        control={posForm.control}
                        render={({ field }) => (
                          <div className="flex items-center space-x-2.5">
                            <Checkbox
                              ...
                              onCheckedChange={field.onChange}
                            />
                            <Label htmlFor="securePosPoints" className="font-semibold text-sm cursor-pointer select-none">
                              Customer Points
                            </Label>
                          </div>
                        )}
                      ...
                      {/* Exchange Permission Toggle */}
                      <Controller
                        name="securePosExchange"
                        control={posForm.control}
                        render={({ field }) => (
                          <div className="flex items-center space-x-2.5">
                            <Checkbox
                              id="securePosExchange"
                              checked={field.value}
                              onCheckedChange={field.onChange}
                            />
                            <Label htmlFor="securePosExchange" className="font-semibold text-sm cursor-pointer select-none">
                              Exchange
                            </Label>
                          </div>
                        )}
