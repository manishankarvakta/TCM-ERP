...
import { FiAlertCircle, FiPlus, FiTrash2, FiSearch, FiCreditCard } from "react-icons/fi";
...
export default function PaymentVoucherForm() {
  ...
  // UI Context State
  const [paymentContext, setPaymentContext] = useState<"SUPPLIER" | "EXPENSE" | "PAYROLL" | "OTHER">("OTHER");
  ...
  const contextLabels = useMemo(() => {
    switch (paymentContext) {
      case "SUPPLIER":
        return {
          title: "Pay Supplier",
          desc: "Record payment to a vendor or supplier.",
          payeeLabel: "Supplier / Payee Name",
          detailsLabel: "Payment Details",
          detailsPlaceholder: "e.g., Payment for Invoice #123, Order #456",
          impact: "Accounts Payable ↓ → Cash/Bank ↓",
          helper: "Payment will reduce what you owe to your suppliers."
        };
      case "EXPENSE":
        return {
          title: "Pay Expense",
          desc: "Record operating expenses (Rent, Utilities, etc.).",
          payeeLabel: "Payee / Vendor",
          detailsLabel: "Expense Details",
          detailsPlaceholder: "e.g., Office Rent for July, Electricity Bill",
          impact: "Expense ↑ → Cash/Bank ↓",
          helper: "Payment will record an immediate business cost."
        };
      case "PAYROLL":
         return {
          title: "Pay Employee / Payroll",
          desc: "Record salary, wages, or employee advances.",
          payeeLabel: "Employee Name / ID",
          detailsLabel: "Payroll Details",
          detailsPlaceholder: "e.g., July Salary, Advance Payment",
          impact: "Payroll Liability ↓ → Cash/Bank ↓",
          helper: "Payment will record salary disbursement or reduce payroll dues."
        };
      default:
         return {
          title: "Other Payment",
          desc: "Record general payments or asset purchases.",
          payeeLabel: "Payee",
          detailsLabel: "Description",
          detailsPlaceholder: "What is this payment for?",
          impact: "Cash/Bank ↓ → Liability / Asset / Expense",
          helper: "General outflow of funds from the business."
        };
    }
  }, [paymentContext]);
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="w-full md:w-[250px]">
                      <Select 
                        ...
                        onValueChange={(val: any) => setPaymentContext(val)}
                      >
                        <SelectTrigger className="bg-background">
                           <SelectValue placeholder="Payment Type" />
                        </SelectTrigger>
                        <SelectContent>
                           <SelectItem value="SUPPLIER">Pay Supplier</SelectItem>
                           <SelectItem value="EXPENSE">Pay Expense</SelectItem>
                           <SelectItem value="PAYROLL">Pay Employee / Payroll</SelectItem>
                    ...
                    <Table>
                        <TableHeader className="bg-muted/50">
                            <TableRow>
                                ...
                                <TableHead className="w-32 text-right">
                                    Credit
                                    <p className="text-[10px] font-normal text-muted-foreground text-right">Enter total amount paid.</p>
                                </TableHead>
                                <TableHead className="w-10"></TableHead>
                            </TableRow>
                        </TableHeader>
        ...
        <div className="flex justify-end gap-3 pt-4">
             ...
             <Button type="submit" disabled={loading || !isBalanced || totalDebit === 0}>Create Payment Voucher</Button>
        </div>
      </form>
    </div>
  );
