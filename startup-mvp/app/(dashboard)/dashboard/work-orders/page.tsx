      ...
      <Tabs defaultValue={tab} className="w-full">
        <TabsList>
          <TabsTrigger value="all" asChild>
            <Link href="/dashboard/work-orders?tab=all&page=1">All</Link>
          </TabsTrigger>
          <TabsTrigger value="PROGRESS" asChild>
            <Link href="/dashboard/work-orders?tab=PROGRESS&page=1">Progress</Link>
          </TabsTrigger>
          <TabsTrigger value="COMPLETE" asChild>
            <Link href="/dashboard/work-orders?tab=COMPLETE&page=1">Complete</Link>
          </TabsTrigger>
          <TabsTrigger value="CANCELED" asChild>
            <Link href="/dashboard/work-orders?tab=CANCELED&page=1">Canceled</Link>
          </TabsTrigger>
          <TabsTrigger value="HOLD" asChild>
            <Link href="/dashboard/work-orders?tab=HOLD&page=1">Hold</Link>
          </TabsTrigger>
          <TabsTrigger value="trash" asChild>
            <Link href="/dashboard/work-orders?tab=trash&page=1">Trash</Link>
          </TabsTrigger>
        </TabsList>
