  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">CRM Follow-ups</h1>
          <p className="text-muted-foreground mt-1">CRM Module Workspace</p>
        </div>
      ...
      <Card className="border-dashed">
        <CardHeader>
          <CardTitle className="text-xl">CRM Follow-ups</CardTitle>
          <CardDescription>
        ...
        <CardContent className="h-64 flex flex-col items-center justify-center text-center text-muted-foreground space-y-3">
          ...
          <div className="max-w-md">
            <h3 className="font-semibold text-foreground text-lg mb-1">CRM Follow-ups</h3>
