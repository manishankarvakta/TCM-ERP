...
export function Toaster({ toasts, onClose }: ToasterProps) {
  ...
  return (
    <div className="pointer-events-none fixed bottom-0 left-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:left-0 sm:top-auto sm:flex-col md:max-w-[420px]">
      {toasts.map((toast) => (
