                  ...
                  <tr key={s.id} className="hover:bg-accent/20 transition-colors">
                    ...
                    <td className="px-4 py-3.5 text-right">
                      <Button
                        ...
                        onClick={() => setDeletingCampaign({ id: s.id, name: s.name })}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-in fade-in duration-150">
          <div className="w-full max-w-md rounded-2xl bg-card border border-border/80 p-6 shadow-2xl space-y-4 animate-in zoom-in-95 duration-150">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Are you sure you want to delete <span className="font-semibold text-foreground">"{deletingCampaign.name}"</span>? This SMS broadcast log and its metrics will be permanently removed.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-2.5 pt-2">
              ...
              >
                {isDeleting ? "Deleting..." : "Delete SMS Broadcast"}
              </Button>
            </div>
          </div>
        </div>
