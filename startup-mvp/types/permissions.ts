...
export const NAVIGATION_STRUCTURE: NavigationItem[] = [
  ...
  // 2. Marketing
  {
    ...
    pages: [
      ...
      { permissionKey: "marketing.publications", path: "/dashboard/marketing/publications", label: "Publications", operations: ["view"] },
      { permissionKey: "marketing.seo", path: "/dashboard/marketing/seo", label: "Publications - SEO", operations: ["view", "edit"] },
      { permissionKey: "marketing.social-media", path: "/dashboard/marketing/social-media", label: "Publications - Social Media", operations: ["view", "edit"] },
      { permissionKey: "marketing.content-calendar", path: "/dashboard/marketing/content-calendar", label: "Publications - Content Calendar", operations: ["view", "edit"] },
      { permissionKey: "marketing.landing-pages", path: "/dashboard/marketing/landing-pages", label: "Publications - Landing Pages", operations: ["view", "edit"] },
