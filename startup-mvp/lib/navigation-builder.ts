...
export const MENU_TEMPLATE: MenuItemData[] = [
  ...
  // 4. CRM
  {
    ...
    subMenu: [
      ...
      { href: "/dashboard/crm/pipeline", label: "Pipeline", icon: "FiTrendingUp", module: "crm" },
      ...
      { href: "/dashboard/crm/service-sales", label: "Service Sales", icon: "FiDollarSign", module: "crm" },
  ...
  // 7. Projects
  {
    ...
    subMenu: [
      ...
      { href: "/dashboard/projects/all", label: "All Projects", icon: "FiBriefcase", module: "projects" },
      { href: "/dashboard/work-management/tasks", label: "Task Center", icon: "FiCheckSquare", module: "projects" },
      { href: "/dashboard/projects/issues", label: "Issues Board", icon: "FiAlertCircle", module: "projects" },
      { href: "/dashboard/work-management/my-day", label: "My Day", icon: "FiClock", module: "projects" },
      { href: "/dashboard/work-management/team", label: "My Team", icon: "FiUsers", module: "projects" },
